...
Creative listening direction is canonical at [`audio-direction-v1.md`](audio-direction-v1.md); bounded orchestration is defined by [`audio-engine-v1.md`](audio-engine-v1.md). This file defines technical finishing/evaluation boundaries only; it does not select music, place SFX or grant creative PASS.
